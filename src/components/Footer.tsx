      ...
      <div className='max-w-7xl mx-auto'>
        <div className='grid grid-cols-4 w-full pt-5'>
          <div className='w-12/12 flex flex-col items-center'>
            <h1 className='text-2xl w-full text-center font-bold pb-5'>Location</h1>
            <iframe
          ...
          <div className='w-/12 flex flex-col items-center'>
            <h1 className='text-2xl w-full text-center font-bold pb-5'>Company</h1>
          ...
          <div className='w-/12 flex flex-col items-center'>
            <h1 className='text-2xl w-full text-center font-bold pb-5'>Product</h1>
            <ul className='gap-12/12 flex flex-col'>
              <li>- Work</li>
              <li>- Service</li>
              <li>- Team</li>
          ...
          <div className='w-12/12 flex justify-end'>
            <div className='flex flex-col items-center'>
              <h1 className='text-2xl w-full font-bold pb-5'>Contact Us</h1>
