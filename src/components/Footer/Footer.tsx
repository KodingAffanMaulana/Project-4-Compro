...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-800 text-white pt-5 p-4 overflow-hidden">
      <div className='max-w-7xl mx-auto'>
        <div className='grid grid-cols-1 gap-5 md:grid-cols-4 w-full md:pt-5'>
          ...
          <div className='flex justify-start'>
            <div className='flex flex-col w-full items-start md:items-center'>
              <h1 className='text-2xl w-full text-start md:text-center font-bold pt-5 md:pt-0 pb-5'>Contact Us</h1>
