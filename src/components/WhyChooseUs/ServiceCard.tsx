...
const ServiceCard2 = ({ icon, title, description }) => {
  return (
...
const Services = () => {
  return (
    <div className="flex bg-gray-100 rounded-lg h-[160px] lg:h-full">
      <ServiceCard
        icon={<img alt='Certified Engineers' src='/assets/about-landing/Certified.svg' width={50} height={50} className='w-[30px] lg:w-[50px]' />}
        title="Certified Engineers"
        description="Deep expertise and experience for optimal and reliable results."
      />
      <ServiceCard2
        icon={<img alt='Delivery on time' src='/assets/about-landing/Delivery.svg' width={50} height={50} className='w-[30px] lg:w-[50px]' />}
